...
function NexusWidgetsContent({
  ...
  return (
    <div className="bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 backdrop-blur-xl border border-zinc-700/50 rounded-3xl p-8 shadow-2xl">
      ...
      {/* Main Description Area - Full Width */}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-xl p-6">
              <div className="text-sm text-zinc-400 space-y-3">
                <p>
                  The Bridge Widget allows you to transfer ETH from one
                  blockchain to another seamlessly.
                </p>
                ...
                <p className="text-xs text-zinc-500 mt-4">
                  Powered by Avail Nexus SDK for secure and fast cross-chain
                  transfers.
                </p>
              </div>
            </div>
        ...
        {activeTab === "transfer" && (
          <div className="space-y-4">
            ...
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-xl p-6">
              <div className="text-sm text-zinc-400 space-y-3">
                <p>
                  The Transfer Widget enables you to move ETH between different
                  blockchain networks.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-zinc-500 mt-4">
                  Simple and efficient cross-chain ETH transfers with minimal
                  fees.
                </p>
              </div>
            </div>
        ...
        {activeTab === "swap" && (
          <div className="space-y-4">
            ...
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-xl p-6">
              <div className="text-sm text-zinc-400 space-y-3">
                <p>
                  The Swap Widget allows you to exchange tokens across different
                  chains and token types.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-zinc-500 mt-4">
                  Cross-chain token swapping with competitive rates and low
                  slippage.
                </p>
              </div>
            </div>
        ...
        {activeTab === "bridgeExecute" && (
          <div className="space-y-4">
            ...
            <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-xl p-6">
              <div className="text-sm text-zinc-400 space-y-3">
                <p>
                  The Bridge & Execute Widget combines bridging with smart
                  contract execution for advanced DeFi operations.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-zinc-500 mt-4">
                  Advanced functionality for sophisticated DeFi strategies
      ...
      {/* Configuration Card Section - Appears Below */}
      <div className="mt-6">
        <div className="bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 backdrop-blur-xl border border-zinc-600/50 rounded-2xl p-6 shadow-xl">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-800/70 border border-zinc-700/70 p-4 rounded-xl text-white/90 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all hover:bg-zinc-800 text-lg font-semibold"
                  placeholder="0.03"
                />
              </div>
              ...
              <button
                ...
                disabled={
                  ...
                  transferFromChain === transferToChain
                }
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-800/70 border border-zinc-700/70 p-4 rounded-xl text-white/90 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all hover:bg-zinc-800 text-lg font-semibold"
                  placeholder="0.01"
                />
              </div>
          ...
          {/* Bridge & Execute Widget Configuration */}
          {activeTab === "bridgeExecute" && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-800/70 border border-zinc-700/70 p-4 rounded-xl text-white/90 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all hover:bg-zinc-800 text-lg font-semibold"
                    placeholder="0.05"
                  />
                </div>
                <div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-600 via-cyan-700 to-blue-700 hover:from-cyan-500 hover:via-cyan-600 hover:to-blue-600 text-white py-4 px-6 rounded-xl transition-all font-bold shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
              >
                ⚡ Bridge & Execute
              </button>
            </div>
